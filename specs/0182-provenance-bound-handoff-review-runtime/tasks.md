...
| T-05 | I2 | New private reviewed-inventory-bound module planner, recovery validator, frame emitter/parser, JCS manifest and reconstructor | R-04–R-07 tests and clean byte-identical reconstruction. Existing-source edit: stop/rebind. |
...
| T-07 | E4 | Controlled paired historical replay across required outcome classes | Fresh shared request/state per case, exact model/tokenizer/tools, byte/token measurements and forensic reconciliation. Historical authority never marked current. |
