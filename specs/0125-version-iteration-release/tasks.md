...
- [ ] Promote principal/maintenance lifecycle, reservation, version-impact,
...
- [ ] Update README/installation/Documenter/workflow for ref-derived
...
- [ ] Extend package-version checker with the shared canonical final/DEV
...
- [ ] Add versioned `iterations.toml` schema and validator for prospective
...
- [ ] Implement exact canonical selector and four-digest static snapshot.
...
- [ ] Implement global occupied-set derivation and principal/maintenance
...
- [ ] Implement versioned canonical JSONL event schema, UTC/ID parser,
...
- [ ] Implement single protected orphan-event branch bootstrap and
  ...
  unavailable.
- [ ] Implement reservation prepare/open/consume/abort and same-line
...
- [ ] Implement guarded closure anchor, explicit UTC time, outgoing
...
- [ ] Implement first maintenance-line bootstrap with approved base,
...
- [ ] Implement one remotely durable candidate/open/withdrawal path and
...
- [ ] Implement principal freeze/ancestry/exact-tree and maintenance
...
- [ ] Run focused event/allocation/closure/release/evidence tests first;
